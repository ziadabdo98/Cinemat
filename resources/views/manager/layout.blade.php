...
use Carbon\Carbon;
$shows =
\App\Models\Show::with('movie')->where('date','>',Carbon::now())->orderBy('date')->get();
@endphp
...
<head>
    ...
    <link rel="shortcut icon"
          href={{ asset('images/branding/logos/favicon.png') }}
          type="image/x-icon">
    ...
    <link rel="stylesheet"
          href="{{ asset('css/font-awesome-all.css') }}">
    <link rel="stylesheet"
          href="{{ asset('css/nunito-font.css') }}">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion"
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center"
               href="{{ route('home') }}">
                <img class="w-100"
                     src="{{ asset('images/branding/logos/logo-w.png') }}"
                     alt="cinemat white logo">
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li
                class="nav-item {{ Route::is('manager.dashboard')?'active':'' }}">
                <a class="nav-link"
            ...
            <li
                class="nav-item {{ Route::is('manager.movies.*')?'active':'' }}">
            ...
            <li class="nav-item {{ Route::is('manager.shows.*')?'active':'' }}">
                ...
                <div id="collapseShow"
                     class="collapse {{ Route::is('manager.shows.*')?'show':'' }}"
                     aria-labelledby="headingTwo"
                     data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle"
                               ...
                               aria-expanded="false">
                                ...
                                <!-- Counter - Alerts -->
                                <span
                                      class="badge badge-danger badge-counter">{{ $shows->count() }}</span>
                            </a>
                            <!-- Dropdown - Alerts -->
                                   ...
                                   href="{{ route('manager.shows.show',$show->id) }}">
                                    <div class="mr-3">
                                        <div class="icon-circle bg-primary">
                                            <i
                                               class="fas fa-compact-disc text-white"></i>
                                        </div>
                                    </div>
                                    <div>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item"
                                   href="{{ route('manager.movies.index') }}">
                                    <i
                                       class="fas fa-user-tie fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Movies
                                </a>
                                <a class="dropdown-item"
                                   href="{{ route('manager.shows.index') }}">
                                    <i
                                       class="fas fa-users fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Shows
                                </a>
