                            ...
                            <form id="registration_form" action="/register" method="POST">
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <input name="first_name" id="first_name" class="form-control" type="text" value="{{ old('first_name') }}" required />
                                        @include('components.error-message',['field_name' => 'first_name'])
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="last_name">Last Name</label>
                                        <input name="last_name" id="last_name" class="form-control" type="text" value="{{ old('last_name') }}" />
